...
void make_arr(){
    ...
    for(int i = 0; i < 1000; i++) {
        ...
        switch(div_num) {
            case 0:
                SendArr1.push_back(QueryReq{"title_" + std::to_string(target)});
                break;
            case 1:
                SendArr2.push_back(QueryReq{"title_" + std::to_string(target)});
                break;
            case 2:
                SendArr3.push_back(QueryReq{"title_" + std::to_string(target)});
                break;
            case 3:
                SendArr4.push_back(QueryReq{"title_" + std::to_string(target)});
                break;
            case 4:
                SendArr5.push_back(QueryReq{"title_" + std::to_string(target)});
                break;

            case 5:
                SendArr6.push_back(QueryReq{"title_" + std::to_string(target)});
                break;
            case 6:
                SendArr7.push_back(QueryReq{"title_" + std::to_string(target)});
                break;
            case 7:
                SendArr8.push_back(QueryReq{"title_" + std::to_string(target)});
                break;
            case 8:
                SendArr9.push_back(QueryReq{"title_" + std::to_string(target)});
                break;
            case 9:
                SendArr10.push_back(QueryReq{"title_" + std::to_string(target)});
                break;
...
void send_arr(std::vector<QueryReq> arr){
    std::string url = API_BASE_URL + "/todos";
